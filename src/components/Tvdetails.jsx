  ...
  return info ? (
    ...
    >
      ...
      {info.details.seasons.map((s,i) =>(
          <div className="w-[15vw] m-[8%]">
          <img
            className="shadow-[8px_17px_28px_2px_rgba(0,0,0,0.5)] h-[30vh] min-w-[15vw] object-cover"
      ...
      <div className="w-[100%] flex overflow-y-hidden mb-5"></div>
      <Horizontalcards
        data={
